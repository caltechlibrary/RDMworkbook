...
**What it the estimated total data storage volume you’ll need over the next five years?**
...
**Does your data require meeting any specific security standards?**

*Example: My data will include some human-subjects data, so my storage system must be HIPAA compliant.*
...
*Example: I have the following systems available to me: my computer, a Time Machine backup, a departmental server, institutional Google Drive, and Dropbox.*
...
------------------------------------------------------------------
Example Storage         Example Backup 1      [Example Backup 2]
--------------------    --------------------  --------------------
*My computer, with      *HIPAA-compliant      *[none]*
added security          institutional
restrictions*           Google Drive*
--------------------    --------------------  --------------------
