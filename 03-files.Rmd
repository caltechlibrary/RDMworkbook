...
![Example of organizational exercise. Image is of blue (group folder, text in \[\] brackets), pink (single folder, text in "" quotes), and yellow (data type, regular text) sticky notes, each with its own label, organized hierarchically on a wooden desktop.](images/03_CardSorting.jpg)
