...
\_\_ Editable image files (e.g. Photoshop)

**Publications**

\_\_ Published article in .PDF format

\_\_ Final version of the article in editable document format (e.g. .DOCX)
