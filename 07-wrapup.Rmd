...
*Example: Data is stored in a .CZI file format, which is a proprietary Zeiss image format for microscopes. These files do not open in other software.*
...
*Example: I can use the Bio-Formats tool to convert .CZI files to: .AVI, .CH5, .DCM/.DICOM, .EPS/.EPSI/.PS, .ICS/.IDS, .JPG, .JP2/.J2K/.JPF, .MOV, .OME.TIFF/.OME.TIF, .OME/.OME.XML, .PNG, .TIFF/.TIF.*
