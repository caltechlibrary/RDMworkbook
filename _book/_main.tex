...
\emph{Example: My data will include some human-subjects data, so my storage system must be HIPAA compliant.}
...
\emph{Example: I have the following systems available to me: my computer, a Time Machine backup, a departmental server, institutional Google Drive, and Dropbox.}
...
\emph{Example: My primary storage will be my computer with added security restrictions. I will use the institutional Google Drive, which is HIPAA-compliant, as my backup. I will not use a second backup because my first backup is remote.}
...
\textbf{3. Review the \href{https://journals.plos.org/plosone/s/recommended-repositories}{list of recommended data repositories from PLOS}. Is there a logical disciplinary data repository for some or all of your data?}
...
\textbf{5. Do you have a preferred \href{https://sharing.nih.gov/data-management-and-sharing-policy/sharing-scientific-data/generalist-repositories}{generalist data repository}?}
...
\textbf{6. Pick a \href{https://sharing.nih.gov/data-management-and-sharing-policy/sharing-scientific-data/generalist-repositories}{generalist data repository} and deposit the remainder of your data.}
...
\textbf{7. Confirm that the repository/repositories issued a permanent identifier, ideally a DOI, for each data deposit.}

DOIs make data more FAIR \citep{wilkinson_fair_2016}. If you did not receive a permanent link, such as a DOI, during deposit, return to step 2 and pick a different data repository for your data.

\emph{Example: CaltechDATA provides DOIs for all deposits. FlyBase provides stable links to data reports using FlyBase ID numbers.}
...
\_\_ Share data with its DOI or, as applicable, other permanent link.
