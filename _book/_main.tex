...
\textbf{\emph{Source:}} \emph{This exercise was adapted from the ``Project Close Out Checklist'' \citet{briney_project_2020}.}
...
\textbf{\emph{Source:}} \emph{This exercise was adapted from the ``Leveling Up Data Management'' \citet{briney_leveling_2023}.}
...
\textbf{\emph{Source:}} \emph{This exercise is based on the ``File Naming Convention Worksheet'' \citet{briney}\_file\_2020.}
...
\textbf{\emph{Source:}} \emph{This exercise was adapted from the ``Data Departure Checklist'' \citet{goben_data_2023}.}
