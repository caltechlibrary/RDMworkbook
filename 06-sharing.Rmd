...
***Instructions:*** *Fill out the worksheet for the collection data being shared. Each group of files being deposited into a repository should have an accompanying README file. Note that some data repositories that collect a specific type of data do not accept README files and instead ask for detailed information about the data during the deposit process.*
...
*Example: Kristin Briney (briney@caltech.edu)*
...
*Example: The author received no specific funding for this work.*
...
**For any spreadsheet files, create a data dictionary (see [Exercise 2.3: Create a Data Dictionary](#data-dictionary)). Either 1) copy the data dictionary contents here; or 2) share the data dictionary as a separate file, making sure to add the data dictionary to the above list of files and their descriptions.**
